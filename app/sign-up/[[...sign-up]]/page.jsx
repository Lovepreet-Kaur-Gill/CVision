...
export default function SignInPage() {
  ...
  return (
    // 🔴 FIXED LAYOUT: Removed 'flex items-center' from here to fix the top cutoff bug 🔴
    <div className="fixed inset-0 z-[99999] bg-[#020308] overflow-y-auto transition-colors duration-300">
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        /* DEEP CLERK CSS OVERRIDES FOR GLASS EFFECT - HIGH BLUR */
        .cl-card {
        ...
        .cl-formButtonPrimary:hover {
          box-shadow: 0 10px 25px -5px rgba(34, 211, 238, 0.6) !important;
        ...
        .cl-dividerText { color: #64748b !important; }
        .cl-formFieldLabel { color: #e2e8f0 !important; font-weight: 500 !important; }
        .cl-footerActionLink { color: #22d3ee !important; font-weight: 600 !important; }
        .cl-footerActionLink:hover { color: #67e8f9 !important; text-shadow: 0 0 8px rgba(34,211,238,0.5) !important; }
      `}} />
      ...
      <div className="relative z-10 min-h-full flex flex-col items-center justify-center py-12 px-6 animate-fade-up">
        ...
        <div className="mb-10 flex flex-col items-center text-center">
          ...
          <h1 className="font-syne font-extrabold text-3xl text-white tracking-tight">
            Welcome to <span className="glow-text text-cyan-400">CVision</span>
          </h1>
          <p className="mt-2 text-xs font-bold text-slate-400 tracking-widest uppercase">
            Authenticate to sync your career
          </p>
        </div>
